...
import '../../job_post_screen/provider/toggle_provider.dart';

class EditJobManagementScreen extends StatefulWidget {
  const EditJobManagementScreen({super.key});

  @override
  State<EditJobManagementScreen> createState() =>
      _EditJobManagementScreenState();
}

class _EditJobManagementScreenState extends State<EditJobManagementScreen> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Update your job details to keep helpers informed",
                            ...
                            children: [
                              DropdownButtonFormField<String>(
                                ...
                                onChanged: (newValue) {
                                  ref
                                          .read(
                                            selectedJobTypeProvider.notifier,
                                          )
                                          .state =
                                      newValue;
                                },
                            ...
                            children: List.generate(
                              ...
                              (index) => Column(
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        jobRequireTitleControllers[index],
                                    decoration: InputDecoration(
                                      hintText: 'Enter job title',
                                      hintStyle: style.bodyMedium?.copyWith(
                                        color: AppColors.inputTextColor,
                      ...
                      Consumer(
                        builder: (_, ref, _) {
                          return GestureDetector(
                            onTap: () {
                              if (ref.watch(jobRequirementsNumberProvider) <
                                  4) {
                                ref
                                    .read(
                                      jobRequirementsNumberProvider.notifier,
                                    )
                                    .state++;
                              }
                            },
