...
class AfterAcceptJobUserSide extends StatefulWidget {
  const AfterAcceptJobUserSide({super.key});

  @override
  State<AfterAcceptJobUserSide> createState() =>
      _AfterAcceptJobUserSideState();
}

class _AfterAcceptJobUserSideState extends State<AfterAcceptJobUserSide> {
  @override
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "You’ve successfully secured a helper. Review the details below and get ready for the scheduled time.",
